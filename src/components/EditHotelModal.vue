         ...
         <div class="modal-dialog">
           <div class="modal-content">
             <div class="modal-header">
               <h1 class="modal-title fs-5" id="updateHotelModalLabel">Update Hotel</h1>
             ...
             <div class="modal-body">
               <form id="updateHotelForm" name="updateHotelForm">
                       ...
                       <div class="mb-3">
                         ...
                         <input type="number" class="form-control" id="hotelAdd" placeholder="Enter hotel address" v-model="hotelAdd">
                       </div>
                       <div class="mb-3">
                       ...
                       <div class="mb-3">
                         ...
                         <input type="text" class="form-control" id="contactInfo" placeholder="Enter the hotel contact info" v-model="contactInfo">
                       </div>
                       <div class="mb-3">
                         <label for="hotelAmount" class="form-label">Hotel amount</label>
                         <input type="text" class="form-control" id="hotelAmount" placeholder="Enter the hotel amount" v-model="amount">
                       </div> 
                     </form>
             </div>
...
function updateHotel() {
  ...
  store.dispatch('updateHotel', hotel).then(() => {
    hotelName.value = '';
    ...
    contactInfo.value = '';
    amount.value = '';
    document.querySelector('#updateHotelModal').classList.remove('show');
    document.querySelector('#updateHotelModal').style.display = 'none';
