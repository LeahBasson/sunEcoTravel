              ...
              <div class="modal-body">
                <form @submit.prevent="updateUser">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="firstName" placeholder="Enter user first name" v-model="firstName">
                  </div>
                  <div class="mb-3">
                    <label for="lastName" class="form-label">Last name</label>
                    <input type="text" class="form-control" id="lastName" placeholder="Enter user last name" v-model="lastName">
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="emailAdd" placeholder="Enter user email" v-model="emailAdd" required>
                  </div>
                  <div class="mb-3">
