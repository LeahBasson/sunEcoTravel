...
class Hotels {
    fetchHotels(req, res) {
        try {           //try statement is used to handle errors
            const strQry = `SELECT hotelID, hotelName, hotelDescription, hotelAdd, country, city, imageURL, Amenities
            FROM Hotels;
            `
    ...
    recentHotels(req, res) {
        try{
            const strQry = `
            SELECT hotelID, hotelName, hotelDescription, hotelAdd, country, city, imageURL, Amenities
            FROM Hotels
